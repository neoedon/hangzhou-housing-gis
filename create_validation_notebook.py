...
nb = nbf.v4.new_notebook(cells=[
    md("# 杭州住房 GIS · 数据整合验证\n\n## tl;dr\n\n本笔记是本地 GIS 的可复算伴随文件。执行后核对：3,121 条帖子（670 条正文/说明）、179 行候选、95 条学校档案、3,701 条年度招生明细；价格分为 2,341 条历史成交、122 条挂牌线索和 38 条小区参考价线索。\n\n这些是索引覆盖，不是全部点位和业务事实已核实。"),
